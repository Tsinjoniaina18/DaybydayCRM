    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            ...
            <a href="#database" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="fa fa-database sidebar-icon "></i><span id="menu-txt">{{ __('Databases') }}</span>
                <i class="icon ion-md-arrow-dropup arrow-side sidebar-arrow"></i></a>
            <div class="collapse" id="database">
                <a href="{{ route('database.index')}}" class="list-group-item childlist"> <i
                            class="bullet-point"><span></span></i> {{ __('Reset') }}</a>
                <a href="{{ route('database.import')}}" class="list-group-item childlist"> <i
                            class="bullet-point"><span></span></i> {{ __('Importer CSV') }}</a>
            </div>
